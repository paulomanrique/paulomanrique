...
- 🖼️ **[ssh-image-paste-windows](https://github.com/paulomanrique/ssh-image-paste-windows)** — Paste images from the Windows clipboard into Codex, Claude Code, or any CLI running over SSH in Windows Terminal. Uploads the image with SCP and inserts its remote path while preserving normal clipboard and hotkey behavior in local sessions.
...
- 🧬 **[exodus-for-ais](https://github.com/paulomanrique/exodus-for-ais)** — Linux headless port of Roger Sanders' Exodus Mega Drive emulator with an MCP server, so AI agents can drive Active Disassembly through an API: execution-guided code/data separation, jump-table recovery, breakpoints, watchpoints, and traces. Verified against a Windows MSVC build by a cycle-equivalence gate — byte-identical traces over 18,941 68000 instructions.
...
- 🏞️ **[pitfall-2600-genesis](https://github.com/paulomanrique/pitfall-2600-genesis)** — A Sega Genesis / Mega Drive port of Activision's *Pitfall!* (Atari 2600, 1982), reimplemented in C with SGDK from Thomas Jentzsch's [commented disassembly](https://www.romhacking.net/documents/521/) — pixel-exact collision and original timings, shipped both as a 1:1 port and as a 16-bit remaster with all-new artwork. [Play it on itch.io](https://sirvh.itch.io/pitfall-2600-genesis).
- 👾 **[hong-kong-97-genesis](https://github.com/paulomanrique/hong-kong-97-genesis)** — A 100% faithful Sega Genesis / Mega Drive port of the infamous SNES *Hong Kong 97* (1995) — reverse-engineered from the original ROM with a custom 65816 disassembler and reimplemented in C with SGDK. [Play it on itch.io](https://sirvh.itch.io/hong-kong-97-genesis).
- 👾 **[hong-kong-97-sms](https://github.com/paulomanrique/hong-kong-97-sms)** — A native C/Z80 port of *Hong Kong 97* for the Sega Master System, reconstructed from the SNES disassembly with target-native gameplay, SN76489 music, and no embedded SNES ROM or 65816 interpreter. [Play it on itch.io](https://sirvh.itch.io/hong-kong-97-master-system).
